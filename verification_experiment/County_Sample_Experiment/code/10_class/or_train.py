...
testloader = DataLoader(dataset=testset, batch_size=410, shuffle=True)
...
class discriminator(nn.Module):
    def __init__(self):
        ...
        self.cov  = nn.Sequential(                          #in:1x12x12
                    nn.Conv2d(in_channels = 1,              #out:64*6*6
                             out_channels = 64,
                             kernel_size = 4,
                             stride = 2,
                             padding = 1,
                    ...
                    nn.Conv2d(in_channels = 64,            # 128*3*3
                             out_channels = 128,
                             kernel_size = 3,
                             stride = 1,
                             padding = 1,
                    ...
                    nn.Conv2d(in_channels = 128,           # 256*3*3
                             out_channels = 256,
                             kernel_size = 3,
                             stride = 1,
                             padding = 1,
                    ...
                    nn.Conv2d(in_channels = 256,            # 512*3*3
                             out_channels = 512,
                             kernel_size = 3,
                             stride = 1,
                             padding = 1,
